            ...
            <nav id="sidebar">
                <div class="sidebar_blog_1">
                    <div class="sidebar-header">
                        <!-- Logo removed as per existing HTML -->
                    </div>
                            ...
                            <div class="right_topbar ml-auto">
                                <div class="icon_info d-flex align-items-center">
                                    <ul class="d-flex align-items-center mb-0">
                                        ...
                                        <li><a href="<?= base_url('admin/notification-center') ?>" class="notif-gold-luxury"><i class="fa fa-bell-o"></i><span class="notif-badge-premium">2</span></a></li>
                                    </ul>
